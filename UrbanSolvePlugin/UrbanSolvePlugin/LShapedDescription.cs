...
{
    class LShapedDescription : BuildingDescription
    {
        ...
        public LShapedDescription(Point3d refPoint, Program program, double glazingRatio, double minLength, double maxLength, double startLength,
            ...
            base(refPoint, program, glazingRatio, minLength, maxLength, startLength, minWidth, maxWidth, startWidth, minStoreyNumber, maxStoreyNumber, startStoreyNumber, storeyHeight, rotation, isCentered)
        {
            ...
            this.typology = Typology.lShaped;
        }
        ...
        public override Building getBuilding(double[] values)
        {
            try
            {
                return new LShapedBuilding(this, refPoint, values[0], values[1], Convert.ToInt32(values[2]), values[3], storeyHeight, rotation, isCentered);
            } 
        ...
        {
            return new LShapedBuilding(this, refPoint, initialLength, initialWidth, initialStoreyNumber, initialDepth, storeyHeight, rotation, isCentered);
        }
        ...
        {
            LShapedGeometry actual = new LShapedGeometry(initialLength, initialWidth, initialDepth, initialStoreyNumber, storeyHeight, rotation, isCentered, refPoint);
            return new DescriptionGeometry(refPoint, "L", actual.geometry);
        }
